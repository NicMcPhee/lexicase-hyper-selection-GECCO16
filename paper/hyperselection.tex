...
Lexicase selection is a method for selecting individuals to serve as parents in population-based stochastic search algorithms such as GP~\cite{Helmuth:2014:ieeeTEC, Spector:2012:GECCOcompANEW}. As a behavior-based search driver~\cite{Krawiec:2015:GPTP}, % I think this citation is an important tie to Krawiec's work
