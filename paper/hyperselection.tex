...
Lexicase selection is a method for selecting individuals to serve as parents in population-based stochastic search algorithms such as GP~\cite{Helmuth:2014:ieeeTEC, Spector:2012:GECCOcompANEW}. As a behavior-based search driver~\cite{Krawiec:2015:GPTP}, it can be used any time that potential parents are assessed with respect to multiple test cases.
