...
%\footnote{Due to a bug, an instruction equivalent to \texttt{exec_noop} was included in the instruction set for the runs on the problems Count Odds, Mirror Image, Vector Average, Double Letters, String Lengths Backwards, and X-Word Lines. See Footnote~% \ref{footnote:autoconstructive-rand-integer-bug} on page~%\pageref{footnote:autoconstructive-rand-integer-bug}
